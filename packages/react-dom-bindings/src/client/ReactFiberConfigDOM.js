...
import {
  traverseFragmentInstanceHostComponentsAndTexts,
  getFragmentParentHostComponentOrRootFiber,
  getInstanceFromHostFiber,
  isFiberFollowing,
  isFiberPreceding,
  getFragmentInstanceHostComponentOrTextSiblings,
  traverseFragmentInstanceHostComponentsAndTextsDeeply,
...
FragmentInstance.prototype.dispatchEvent = function (
  ...
  const parentHostFiber = getFragmentParentHostComponentOrRootFiber(
    this._fragmentFiber,
  );
...
if (enableFragmentRefsScrollIntoView) {
  ...
  FragmentInstance.prototype.scrollIntoView = function (
    ...
    if (children.length === 0) {
      const hostSiblings = getFragmentInstanceHostComponentOrTextSiblings(
        this._fragmentFiber,
      );
      const targetFiber = resolvedAlignToTop
        ? hostSiblings[1] ||
          hostSiblings[0] ||
          getFragmentParentHostComponentOrRootFiber(this._fragmentFiber)
